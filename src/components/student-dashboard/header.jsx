    ...
    <header className="bg-surface border-b border-app sticky top-0 z-50 transition-colors duration-300">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center justify-center w-10 h-10 rounded-full border border-[#2ea043] text-app hover:bg-[#2ea043]/10 transition-colors"
          ...
          <div className="relative profile-dropdown">
            ...
            >
              <div className="w-8 h-8 bg-[#2ea043] rounded-full flex items-center justify-center text-sm font-semibold text-white">
                {initials}
              </div>
